...
open class BarcodeScannerViewController: UIViewController {
  ...
  open override func viewDidLoad() {
    ...
    open override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "segueWithResults" {
            let vc = segue.destination as! BookAPIPageViewController
            vc.googleBook = googleBook
            vc.goodreadsBook = goodreadsBook
            vc.openLibraryBook = openLibraryBook
        }
    }
